$(document).ready(function() {
  ...
  function getPartial(partial) {
    ...
    } else if (partial === "rentPage") { //ajax geting final.json
      $.getJSON("jsonDatabase/final.json", function(data) {
        ...
        $.each(data, function(index, item) {
          html += '<div class="col-xs-12 col-md-4 jsonCat">' +
            ...
            '<div class="dinoCharacteristics"><small>Characteristics </small>' + item.Characteristics + '</div>' +
    ...
    } else if (partial === "orderPage") { //ajax get order2.html
